...
% Vissim = actxserver('Vissim.Vissim.22'); % Vissim 2022
Path_of_COM_Basic_Commands_network = cd; %'C:\Users\Public\Documents\PTV Vision\PTV Vissim 2022\Examples Training\COM\Basic Commands';
...
volAvg = get(Vissim.Net.Links.GetItemByKey(Link_number), 'AttValue', 'Concatenate:LinkEvalSegs\Volume(Avg,Avg,All)');
disp(['Link evaluation results for link #',num2str(Link_number),': ',volAvg]);
